		...
		<StyledHome>
			...
			<div className="right">
				<div className="tit-wrap">
					...
					<p>
                        아이디어를 행동으로 엔지니어 "김창영" 입니다.😀
                        
                        <br />"Talk the Talk, Walk the Walk!"
                        <br />
                        데이터를 활용하여 기존 프로세스를 개선하거나,
                        <br />
                        새로운 가치를 창출하는 것에 보람을 느낍니다.
                        <br />
                        현실 속에서 문제들을 데이터를 활용하여 해결하는데 관심이 있습니다.
					</p>
				</div>
				<section>
					...
					<ul>
						<li>
							<span>Name : </span>Chang-Yeong Kim
						</li>
						<li>
							<span>Address : </span>Seoul, Republic of Korea
						</li>
						<li>
							<span>Email : </span>changzero.kim@gmail.com
						</li>
					</ul>
				</section>
